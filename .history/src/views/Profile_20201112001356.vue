                            ...
                            <div class="col-lg-4 order-lg-3 text-lg-right align-self-lg-center">
                                <div class="card-profile-actions py-4 mt-lg-0">
                                    ...
                                    <base-button disabled type="warning" size="sm" class="mr-4" style='margin-bottom:10px'>Fullstack JS/Kotlin/Groovy/NPM</base-button>
                                     ...
                                     <base-button disabled type="warning" size="sm" class="mr-4" style='margin-bottom:10px'>MOCHA
                                      <base-button disabled type="warning" size="sm" class="mr-4" style='margin-bottom:10px'>API
                                       <base-button disabled type="warning" size="sm" class="mr-4" style='margin-bottom:10px'> BLUE/GREEN
                                        <base-button disabled type="warning" size="sm" class="mr-4" style='margin-bottom:10px'>Community
                                         <base-button disabled type="warning" size="sm" class="mr-4" style='margin-bottom:10px'>Circular Ecn.
                                          <base-button disabled type="warning" size="sm" class="mr-4" style='margin-bottom:10px'>CO2 Offset
                                          <base-button disabled type="warning" size="sm" class="mr-4" style='margin-bottom:10px'>Iterative
                                          <base-button disabled type="warning" size="sm" class="mr-4" style='margin-bottom:10px'>XP/SAFe/DevOps
                                          <base-button disabled type="warning" size="sm" class="mr-4" style='margin-bottom:10px'>Subnetting / VLANs / Wireguard / nmap
                                          <base-button disabled type="warning" size="sm" class="mr-4" style='margin-bottom:10px'>CrashDumps / Live-Debugging / Multi-Cluster
                                          <base-button disabled type="warning" size="sm" class="mr-4" style='margin-bottom:10px'>HighPerf / Compute
                                          <base-button disabled type="warning" size="sm" class="mr-4" style='margin-bottom:10px'>Open Source
                                          <base-button disabled type="warning" size="sm" class="mr-4" style='margin-bottom:10px'>Servicemesh
                                          <base-button disabled type="warning" size="sm" class="mr-4" style='margin-bottom:10px'>Anti-W.F. 
                                           <base-button disabled type="warning" size="sm" class="mr-4" style='margin-bottom:10px'>Neg Balance Accounting of Dev & Ops in Uptime currencies
                                          Open Standards
                                          Communication Overhead
                                          <base-button disabled type="warning" size="sm" class="mr-4" style='margin-bottom:10px'>Monitoring and Visibility Radiation x-Team.
                            ...
                            <div class="col-lg-4 order-lg-1">
                                <div class="card-profile-stats d-flex justify-content-center">
                                    ...
                                    <div>
                                        ...
                                        <span class="description">Web and InfraOps Technologies</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mt-5 py-5 border-top text-left">
                            <div class="row justify-content-center">
                                <div class="col-lg-9 stevek-dark">
                                        ...
                                        <p>
                                        As long as its spicy and from Asia, I'm in.
                                        </p>
                                        ...
                                        PopUp Content: 'Claudio Naranjo ist ein gefragter Referent und Seminarleiter bei verschiedenen internationalen Gesellschaften für Humanistische und Transpersonale Psychologie. Er ist Hauptredner mehrerer nationaler und internationaler Gestaltkonferenzen und ein international renommierter Wissenschaftler und Redner.' (Mhh.. let me code some kind of Zeppelin Compatible Multi Language i18n Process here soon, shall I? I ought to, riiiight?)
                                        -->

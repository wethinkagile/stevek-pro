                        ...
                        <div class="row justify-content-center">
                            ...
                            <div class="col-lg-4 order-lg-3 text-lg-right align-self-lg-center">
                                <div class="card-profile-actions py-4 mt-lg-0">
                                    ...
                                    <base-button disabled type="warning" size="sm" class="mr-4" style='margin-bottom:10px'>Fullstack JS/Kotlin/Groovy/NPM
                                      <base-button disabled type="warning" size="sm" class="mr-4" style='margin-bottom:10px'> TS/JASMINE
                                      <base-button disabled type="warning" size="sm" class="mr-4" style='margin-bottom:10px'> CHAI BDD
                                       <base-button disabled type="warning" size="sm" class="mr-4" style='margin-bottom:10px'>TDD/CI 

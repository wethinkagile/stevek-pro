<template>
    <div  style="width:100%" class="profile-page">
        <section  style="width:100%" class="section-profile-cover section-shaped my-0">
            <div  style="width:100%" class="shape shape-style-1 shape-primary shape-skew alpha-4">
                <span></span>
                <span></span>
                <span></span>
                <span></span>
        ...
        <section class="section section-skew"  style="width:100%">
            <div class="container"  style="width:100%">
                <card shadow class="card-profile mt-300" no-body  style="width:100%">
                    <div class="px-4"  style="width:100%">
                        <div class="row justify-content-center"  style="width:100%">
                            <div class="col-lg-1 order-lg-1" style="width:100%">
                                <div class="card-profile-image"  style="width:100%">
                                    <a href="#">
                                        <img v-lazy="'img/theme/mountain-sunset.jpg'" class="rounded-circle">
                                    </a>
                                </div>
                            </div>
                            <div class="col-lg-4 order-lg-3 text-lg-right align-self-lg-center"  style="width:100%">
                                <div class="card-profile-actions py-4 mt-lg-0"  style="width:100%">
